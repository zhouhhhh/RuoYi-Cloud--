            ...
            <el-row :gutter="20" class="mb8">
                <el-col :span="12">
                    <div class="info-item">
                        ...
                        <span class="info-value plaintext">
                            {{ parseTime(info.lastFollowTime, '{y}-{m}-{d} {h}:{i}:{s}') }}
                        </span>
                    </div>
                </el-col>
                <el-col :span="12">
                    <div class="info-item">
                        ...
                        <span class="info-value plaintext">
                            {{ parseTime(info.createTime, '{y}-{m}-{d} {h}:{i}:{s}') }}
                        </span>
                    </div>
                </el-col>
            </el-row>
                ...
                <el-col :span="12">
                    <div class="info-item">
                        ...
                        <span class="info-value plaintext">
                            {{ parseTime(info.updateTime, '{y}-{m}-{d} {h}:{i}:{s}') }}
                        </span>
                    </div>
                </el-col>
                <el-col :span="12">
